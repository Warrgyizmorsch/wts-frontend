      ...
      <div class="swiper-slide">
        <div class="hero-content-wrapper">
          <div class="home-hero-content">
            ...
            <h1 class="hero-title">
              <span style="color: #FC9118;">Hassle-Free Visa Consultancy!</span> 
            </h1>
            <span
           ...
           <div  class="hero-form">
    @include('./components/landing-registration-form')
        </div>
      </div>
    </div>
  </div>
...
<div class="hero-statss">
 ...
 <section class="travel-service-section">
  <div class="travel-service-container">
    <h2 class="section-title">Travel <span class="section-title-span">Support Services</span></h2>
...
@media (max-width: 600px) {
  ...
  .travel-icon {
    ...
    <!-- Countries section  -->
     <style>
  /* Capitalize all words inside this section */
  .capitalize-text {
      text-transform: capitalize;
  }
</style>
    <section class="new-countries-section capitalize-text">
        <div class="container">
     ...
     <style>
        ...
        .new-home-form-stage.active {
            opacity: 1;
            transform: translateX(0);
            pointer-events: auto;
        }

        .new-home-form-stage.slide-in-left {
            transform: translateX(-50px);
        }

        .new-home-form-stage.slide-in-right {
            transform: translateX(50px);
        }
        ...
        .new-home-form-options {
            display: flex;
            flex-wrap: wrap;
            gap: 10px;
        }

        .new-home-form-option {
            background: #fff;
            color: black;
            border-radius: 8px;
            padding: 10px 16px;
        ...
        .new-home-form-option:hover,
        .new-home-form-option.selected {
            border-color: white;
            background: #1C2C59;
            color: white;
        }

        .new-home-form-buttons {
            display: flex;
        ...
        .new-home-form-btn:disabled {
            display: none;
        }

        .new-home-form-progress {
            display: flex;
        ...
        .new-home-form-progress div.active {
            background: white;
            color: #1C2C59;
            border-color: white;
        }

        .new-home-form-progress-line {
        ...
        .new-home-form-card-country {
            display: flex;
            align-items: center;
            gap: 8px;
        }

        .new-home-form-flag-circle img {
            height: 32px;
            width: 32px;
            object-fit: cover;
        ...
        .new-home-form-card-country:hover .new-home-form-flag-circle img {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const countryCards = document.querySelectorAll('.new-country-card');
        const mainImage = document.getElementById('countryImage');
        const featureList = document.getElementById('countryFeatures');
        ...
        countryCards.forEach(card => {
            card.addEventListener('click', () => {
                ...
                const key = card.getAttribute('data-country');
                ...
                data.features.forEach(f => {
                    ...
                    li.style.gap = '8px';
                    li.innerHTML = `<img src="/new-home-images/svg-icons/check-circle.svg" 
                        alt="check" style="height: 20px;"> ${f}`;
  ...
  <div class="process-container">
    <h2 class="process-title">How It Works <span>(Simple 5-Step Process)</span></h2>
...
<section class="new-home-service-section">
        <div class="container">
            <h2 class="new-section-title">
                Our Services: We provide complete end-to-end support:
            </h2>
...
// CTA Section JS Ended
  ...
  <div class="container">
    <h2 class="section-title">
      Seamless <span>Arrival</span> & <span>Virtual Tours</span>
    </h2>
...
<section class="study-guide-section">
  ...
  <div class="visa-help-container">
    <h2 class="visa-help-title">Common Challenges? <span>We Solve Them All!</span></h2>
