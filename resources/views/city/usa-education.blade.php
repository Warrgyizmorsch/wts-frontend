...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your USA Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Discover Leading USA Universities for Your Global Career
            </h2>

            <p class="section-subtext">
                Step into a world of opportunities with top USA universities. Our Study in USA Consultants in {{ $cityName }} help you select the right courses, explore scholarships, and secure admissions to leading American institutions. Begin your study-abroad journey with confidence and move closer to your global career goals today.
            </p>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading USA Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="student-support">
        <div class="container">
            <h2 class="new-section-title" style="color: black;">
                Popular USA Courses Chosen by Indian Students
            </h2>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About USA Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Who are the best USA education consultants in {{ $cityName }}?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            WTS is one of the best USA education consultants in {{ $cityName }}, providing expert guidance for studying in the USA, including course selection, university admissions, scholarships and F-1 student visa support. With personalised counselling, WTS assists students in applying to suitable US universities based on their profile.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How long does the USA admission and visa process take?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            The USA admission and visa process can take a few weeks to several months, depending on application processing, I-20 issuance, and visa interview schedules. We guide you through each step to ensure a smooth process.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                        ...
                        <div class="new-faq-content">
                            Studying in the USA typically costs between $35,000 and $85,000 per year, including tuition and living expenses. WTS USA Education Consultants helps you plan your finances effectively.
                        </div>
                    </div>
                    ...
                    <div class="new-faq-item">
                        ...
                        <div class="new-faq-content">
                            English proficiency tests like IELTS or TOEFL are usually required. Depending on your program, GRE, GMAT, or SAT may also be necessary. WTS helps you identify the exams needed for your chosen course and university.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Can I study in the USA with a gap year?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Yes, US universities accept justified gap years, especially if you’ve gained work experience, completed courses, or pursued relevant activities. WTS helps present your profile strongly despite the gap.
                        </div>
                    </div>
