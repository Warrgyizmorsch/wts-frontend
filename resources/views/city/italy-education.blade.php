...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your Italy Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Top Universities in Italy for {{$cityName}} Students
            </h2>

            <p class="section-subtext">
                Explore world-class education opportunities in Italy and take a confident step toward your global career
                goals. Our Study in Italy Consultants in {{$cityName}} help you identify the right universities, explore
                popular programs, and secure admissions in leading italian institutions.
            </p>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading Italy Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="student-support">
        <div class="container">
            <h2 class="new-section-title" style="color: black;">
                Popular Italy Courses Chosen by Indian Students
            </h2>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About Italy Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Why should students from {{$cityName}} choose Italy for higher education?
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How can Italy Education Consultants in {{$cityName}} help students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Are there English-taught programs available in Italy?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            What is the cost of studying in Italy for {{$cityName}} students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
