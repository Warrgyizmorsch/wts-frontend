...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your Switzerland Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Top Universities in Switzerland for {{$cityName}} Students
            </h2>

            <p class="section-subtext">
                Explore world-class education opportunities in Switzerland and take a confident step toward your global
                career goals. Our Study in Switzerland Consultants in {{$cityName}} help you identify the right
                universities, explore popular programs, and secure admissions in leading Swiss institutions.
            </p>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading Switzerland Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="student-support">
        <div class="container">
            <h2 class="new-section-title" style="color: black;">
                Popular Switzerland Courses Chosen by Indian Students
            </h2>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About Switzerland Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Why should students from {{$cityName}} choose Switzerland for higher education?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Switzerland is known for its world-class education system, globally recognised degrees, strong
                            focus on research and innovation, and excellent academic standards. Students from {{$cityName}}
                            choose Switzerland for its high-ranking universities, industry-oriented programs, multicultural
                            environment, and exceptional quality of education.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How can Switzerland Education Consultants in {{$cityName}} help students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Switzerland Education Consultants in {{$cityName}} provide personalised counselling, help
                            students select the right course and university, assist with applications, offer SOP guidance,
                            support with documentation, and ensure a smooth and transparent admission process.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            What are the popular courses to study in Switzerland?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Popular courses in Switzerland include Engineering, Computer Science, Data Science, Artificial
                            Intelligence, Business Management, Finance, Hospitality Management, Biotechnology, Life
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Are there English-taught programs available in Switzerland?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Yes, many Swiss universities offer English-taught bachelor’s and master’s programs, especially
                            at the postgraduate level, making Switzerland an attractive option for international students.
                        </div>
                    </div>
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            What is the cost of studying in Switzerland for {{$cityName}} students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                            Public universities in Switzerland generally offer affordable tuition fees, while private
                            institutions may have higher costs. Overall, Switzerland provides excellent value for its
                            high-quality education, and scholarship opportunities are available for eligible students.
                        </div>
                    </div>
