...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your Ireland Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Discover Leading Ireland Universities for Your Global Career
            </h2>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading Ireland Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About Ireland Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Who are the best Ireland education consultants in {{ $cityName }}?
