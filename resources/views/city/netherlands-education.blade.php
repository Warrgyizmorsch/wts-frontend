...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your Netherlands Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Top Universities in Netherlands for {{$cityName}} Students
            </h2>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading Netherlands Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="student-support">
        <div class="container">
            <h2 class="new-section-title" style="color: black;">
                Popular Netherlands Courses Chosen by Indian Students
            </h2>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About Netherlands Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Why should students from {{$cityName}} choose Netherlands for higher education?
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How can Netherlands study abroad consultants help students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            What courses can I study in the Netherlands?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Are there English-taught programs available in the Netherlands?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How do education consultant Netherlands services support students from {{$cityName}}?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
