...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your New Zealand Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Discover Leading New Zealand Universities for Your Global Career
            </h2>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading New Zealand Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About New Zealand Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Who are the best New Zealand education consultants in {{ $cityName }}?
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            How long does the New Zealand admission and visa process take?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Is New Zealand a good destination for Indian students?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
