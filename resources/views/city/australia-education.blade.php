...
@section('content')
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">What We Offer as Your Australia Education Consultants in {{$cityName}}</h2>
        </div>
    ...
    <!-- Top Australian Universities Section -->
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">
                Discover Leading Australian Universities for Your Global Career
            </h2>
    ...
    <section class="sop-samples">
        <div class="heading-wrapper">
            <h2 class="new-section-title">Why WTS is a Leading Australian Education Consultant in {{ $cityName }}</h2>
        </div>
    ...
    <section class="new-faq-section">
        <div class="new-faq-container">
            <div class="new-faq-left">
                <h3 class="new-section-title">FAQ About Australia Education Consultants in {{$cityName}}</h3>
                ...
                <div class="new-faq-accordion">
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Who are the best Australian education consultants in {{ $cityName }}?
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Is WTS a reliable consultancy for studying in Australia?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Do WTS consultants support cultural adaptation in Australia?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
                    ...
                    <div class="new-faq-item">
                        <button class="new-faq-btn">
                            Can I get post-arrival support from WTS consultants?
                            <p><span><img src="/new-home-images/svg-icons/faq-plus.svg" alt="Plus icon"></span></p>
                        </button>
                        <div class="new-faq-content">
