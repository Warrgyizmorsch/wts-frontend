...
<head>
  ...
  <meta name="google-site-verification" content="sPxaFG3Lku6i72v1_YDEaXOY9eMp5gwE9nH2rWnCQIw" />

  <link rel="icon" type="image/png" href="/images/favicon.png">
  @php
$route = Route::currentRouteName();
$meta = $meta ?? config('meta.pages.' . $route, config('meta.default'));
  @endphp
  ...
  <script src="{{ asset('new-script.js') }}" defer></script>
  ...
  <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=1211248630570170&ev=PageView&noscript=1" /></noscript>
  <!-- End Meta Pixel Code -->
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Select elements that must be ready
      ...
      if (header) {
        if (heroImg && !heroImg.complete) {
          heroImg.addEventListener('load', finish);
          heroImg.addEventListener('error', finish);
        } else {
          finish();
        }
      } else {
...
$noWhatsappRoutes = ['study_abroad_consultant_v1'];
$specialRoutes = ['landing_page', 'landing_page2', 'study_abroad_consultant'];

$whatsappNumber = in_array($route, $specialRoutes)
  ? '918000915743'
  : '919116076837';

$whatsappMessage = "Hi, I’m looking for visa consultation services. Can you please assist me with the next steps?";
  @endphp

  @if(!in_array($route, $noWhatsappRoutes))
  ...
  @include('layouts.new-header') <!-- Navigation Bar -->
  ...
  @include('layouts.new-footer') <!-- Footer -->
  <button id="backToTop" class="back-to-top">↑</button>
  @if(Route::currentRouteName() !== 'landing_page2' && Route::currentRouteName() !== 'landing_page' && Route::currentRouteName() !== 'study_abroad_consultant' && Route::currentRouteName() !== 'study_abroad_consultant_v1')
    @include('layouts.bottomMenu')
  @endif


  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-K75D7TFP" height="0" width="0"
