                ...
                <div class="hero-second-slide-wrapper">
                    ...
                    <a href="/services/counseling-with-an-expert">
                        <div class="hero-second-slide-card alumni-card">
                            <h4 class="hero-card-title">Alumni Student Discussions</h4>
        ...
        const swiper = new Swiper('.hero-swiper', {
            ...
            on: {
                slideChangeTransitionStart() {
                    document.querySelectorAll('.card-country, .hero-second-slide-card')
                        .forEach(c => c.classList.remove('animate-in'));
                },
...
<!-- 2nd Slider CSS  -->
<style>
    .hero-second-slide-wrapper {
        position: relative;
        width: 100%;
        height: 100%;
        min-height: 500px;
        background: url('/new-home-images/hero-img-2.webp') center/cover no-repeat;
        display: flex;
        align-items: center;
    ...
    /* Animation Trigger */
    .hero-second-slide-card.animate-in {
        opacity: 1;
        transform: scale(1) translateY(0);
        pointer-events: auto;
    }

    .hero-second-slide-card.animate-in:hover {
