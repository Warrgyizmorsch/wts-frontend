...
@section('content')
    ...
    <style>
        ...
        /* GLOBAL RESPONSIVE FIX FOR PTE PAGE */
        ...
        <div class="hero-content-wrapper container">
            ...
            <div class="home-hero-content container">
                ...
                <h1 class="hero-title" style="color:var(--primary-color)">
                    PTE Coaching in {{ $cityName }}<br>
                    <span style="color:black">Score High with Expert Guidance</span>
                </h1>

                <ul style="margin:18px 0;padding-left:0;">
                    <p style="color:black">Looking for trusted PTE coaching in {{ $cityName }}? WTS offers expert-led
                        preparation with structured PTE classes, real exam-level mock tests, personalised feedback, and
                        flexible options including online PTE coaching in {{ $cityName }} to help you achieve your target
                        score confidently.
                    </p>
                </ul>
                ...
                <div class="ielts-image-wrap">
                    ...
                    <div class="band-box">
                        ...
                        <div id="registrationModals" class="registration-form ">
                            <h2 style="margin: 0px;">Book Your Free PTE Demo Class</h2>
    ...
    <section class="ielts-overview">
        ...
        <div class="container">
            ...
            <h2 class="ielts-overview-title">PTE Overview</h2>

            <p class="ielts-overview-text">
                The Pearson Test of English (PTE) is one of the most widely accepted computer-based English proficiency
                exams for studying, working, and migrating abroad. It assesses your skills in speaking, writing, reading,
                and listening through AI-based evaluation, ensuring fast and unbiased results.
            </p class="ielts-overview-text">
            <p>At our pte coaching in {{ $cityName }}, we provide complete preparation covering all exam modules with expert
                strategies, real exam-like practice materials, and regular mock tests to track your progress effectively.
                Our structured training approach focuses on accuracy, time management, and score improvement.</p>

            <p class="ielts-overview-text">Our pte classes in {{ $cityName }} are designed for beginners as well as advanced
                learners, making preparation simple, strategic, and result-oriented so you can achieve your target score
                with confidence.</p>

            <!-- <p class="ielts-overview-text">
                                    As a leading PTE institute in {{ $cityName }}, WTS Study Abroad Consultants prepares students for all four
    ...
    <section class="ielts-metrics">
        ...
        <div class="container">
            ...
            <h2>Our PTE Success in Numbers</h2>
            <!-- <p>A track record that highlights our commitment to PTE success.</p> -->
    ...
    <!-- New Section Where PTE Take -->
    @include('components.where-exam-can-take', ['exam' => 'PTE'])
    ...
    <section class="why-choose">
        ...
        <p>Why Students Prefer Our PTE Coaching in {{ $cityName }}</p>

        <div class="choose-grid">

            <div class="choose-item">
                <i class="fa-solid fa-user-graduate c1"></i>
                <span>Certified PTE Mentors</span>
            </div>
    ...
    <section class="ielts-course">
        ...
        <div class="container">
            ...
            <h2>PTE Course Structure</h2>

            <p class="subtitle">
                At WTS, our PTE coaching program is carefully designed to cover all four core modules of the exam:
                Listening, Reading, Writing, and Speaking.
                Our structured approach helps students build confidence, accuracy, and test readiness.
            </p>

            <a href="javascript:void(0)" class="course-cta js-open-custom-study-modal">Enroll in our PTE Online Coaching
                Program</a>
    ...
    <section class="ielts-test">
        ...
        <div class="container">
            ...
            <h2>Which PTE Test Should You Take?</h2>

            <!-- <p>Choosing the correct PTE test is an important step in your study abroad journey. At WTS Study Abroad
                                    Consultant, we help you understand which option aligns best with your goals.</p> -->

            <div class="test-tabs">
                <div class="test-tab active" data-tab="academic">PTE iBT Test</div>
                <div class="test-tab" data-tab="general">PTE Essentials</div>
            </div>

            <div class="test-content" id="academic">

                <p>This is the most widely accepted PTE test by colleges and universities worldwide. It measures your
                    ability to use
    ...
    <section class="ielts-experts">
        ...
        <div class="container">
            ...
            <h3>Learn from Certified PTE Trainers in {{ $cityName }}</h3>

            <p class="sub">
                Our trainers at WTS bring years of experience in delivering high-quality PTE coaching in {{ $cityName }}.
                You
                receive:
            </p>
            ...
            <div class="experts-wrap">
                ...
                <div class="expert-card">
                    ...
                    <div class="expert-role">PTE Trainer</div>
                    <p class="expert-desc">Experienced PTE Trainer – Certified Instructor with 5+ Years Expertise.</p>
                ...
                <div class="expert-card">
                    ...
                    <div class="expert-role">PTE Trainer</div>
                    <p class="expert-desc">Experienced British Council Certified <br>PTE Trainer – 6+ Years Expertise.</p>
                    <div class="expert-meta">
    ...
    <section class="ielts-plan">
        ...
        <div class="container">
            ...
            <h2><span style="color:var(--primary-color)">Choose Your PTE </span> Preparation Plan</h2>
                ...
                <div class="stack-track" id="track">
                    ...
                    <div class="stack-card">
                        <div class="stack-user">
                            <div><b>Ritika Sharma</b><br><small>Jaipur</small></div>
                        </div>
                        <p>I joined GMAT coaching at WTS Study Abroad Consultant after scoring very low in my first mock
                            test. The faculty explained Quant and Verbal concepts in a very structured way. Their shortcut
                            techniques and doubt-solving sessions helped me improve my score from 520 to 680. Highly
                            recommended for serious GMAT aspirants.
                        </p>
                    </div>
                    ...
                    <div class="stack-card">
                        <div class="stack-user">
                            ...
                            <div><b>Manav Joshi</b><br><small>Delhi</small></div>
                        </div>
                        <p>Choosing WTS Study Abroad Consultant for GMAT preparation was the best decision. The trainers
                            focus deeply on data sufficiency and critical reasoning. Regular sectional tests and detailed
                            feedback helped me understand my weak areas. I finally achieved a 700+ score with their proper
                            guidance.</p>
                    </div>
                    ...
                    <div class="stack-card">
                        <div class="stack-user">
                            ...
                            <div><b>Khushi Patel</b><br><small>Mumbai</small></div>
                        </div>
                        <p>I was searching for a professional GMAT coaching institute with real exam-level mock tests, and
                            WTS truly met my expectations. The practice platform was very close to the actual exam format.
                            Their time-management strategies made a huge difference in my performance</p>
                    </div>

                    <div class="stack-card">
                        <div class="stack-user">
                            <!-- <img src="/images/Neha.jpg"> -->
                            <div><b>Arjun Mehta</b><br><small>Ahemdabad</small></div>
                        </div>
                        <p>Due to my job, I opted for GMAT online coaching at WTS Study Abroad Consultant. The live
                            interactive sessions, recorded lectures, and personalized mentoring were excellent. Even in
                            online mode, I received individual attention and performance analysis after every mock test.</p>
                    </div>

                    <div class="stack-card">
                        <div class="stack-user">
                            <!-- <img src="/images/Ayesha.jpg"> -->
                            <div><b>Sneha Verma</b><br><small>Ajmer</small></div>
                        </div>
                        <p>What makes WTS different is their small batch size and individual mentoring. The faculty helped
                            me strengthen my weak areas in Sentence Correction and Problem Solving. Within a few months of
                            preparation, I was able to reach my target GMAT score confidently.</p>
                    </div>
    ...
    <section class="ielts-cta">
        <div class="container">
            ...
            <div class="cta-box">
                ...
                <div class="cta-image">
                    <img src="/images/PTE.webp" alt="">
                </div>

                <div class="cta-content">
                    <h2>Join the Best PTE Coaching in {{ $cityName }} Today</h2>
                    <p>Start your PTE preparation with WTS Study Abroad Consultants, a trusted PTE coaching centre in
    ...
    <section class="ielts-long">
        <div class="container">
            ...
            <div class="long-box">
                ...
                <h2>PTE Coaching in {{ $cityName }} – Complete Guide for PTE Preparation</h2>

                <p>
                    The Pearson Test of English (PTE) is a globally recognised computer-based English proficiency exam
                    accepted by universities, colleges, and immigration authorities in countries such as Australia, Canada,
                    the UK, and New Zealand. The exam evaluates your Speaking, Writing, Reading, and Listening skills
                    through an AI-based scoring system, ensuring fast, fair, and accurate results.
                </p>

                <p>
                    If you are planning to study or migrate abroad, enrolling in PTE Coaching in {{ $cityName }} can
                    significantly improve your preparation strategy. Professional guidance, structured modules, and real
                    exam practice play a crucial role in achieving a high score. At a trusted PTE Institute in
                    {{ $cityName }}, students receive systematic training aligned with the latest exam pattern and scoring
                    criteria.
                </p>

                <p>Choosing the Best PTE Coaching in {{ $cityName }} means learning from certified trainers who understand
                    scoring algorithms, time management techniques, and high-weightage question types. A professional PTE
                    Coaching Centre in {{ $cityName }} not only focuses on concept clarity but also provides consistent mock
                    practice to boost confidence before the actual exam.</p>
                ...
                <div class="more-content" id="moreContent">
                    ...
                    <h2>Why Choose the Best PTE Coaching in {{ $cityName }}?</h2>

                    <p>
                        Preparing for PTE without expert guidance can be challenging, especially because the exam is fully
                        computer-based and AI-evaluated. Joining the Best PTE Institute in {{ $cityName }} ensures that you
                        understand:
                    </p>

                    <ul>
                        <li>Latest PTE exam format</li>
                        <li>AI scoring patterns</li>
                        <li>Time management strategies</li>
                        <li>High-scoring templates for Speaking & Writing</li>
                        <li>Practice with real exam-level mock tests</li>
                    </ul>

                    <p>At a reputed PTE Coaching in {{ $cityName }}, trainers analyse your performance in detail and provide
                        personalised feedback for improvement. The Best PTE Coaching Centre in {{ $cityName }} focuses on
                        individual weaknesses and converts them into strengths through structured practice sessions.</p>

                    <p>Students looking for flexible options can also enrol in PTE Online Coaching in {{ $cityName }}, which
                        offers live interactive sessions, recorded lectures, and online mock platforms. Whether you choose
                        classroom-based PTE Classes in {{ $cityName }} or online preparation, quality training makes a
                        measurable difference in your score.</p>

                    <h2>PTE Classes in {{ $cityName }} – Structured Module-Wise Preparation</h2>

                    <p>
                        Professional PTE Classes in {{ $cityName }} are designed to cover all four sections of the exam in a
                        step-by-step format. A trusted PTE Institute in {{ $cityName }} ensures balanced training across
                        modules:
                    </p>

                    <h3>Speaking & Writing Module</h3>
                    ...
                    <p>
                        The Best PTE Classes in {{ $cityName }} provide proven templates and speaking fluency strategies
                        that align with AI scoring parameters. Regular speaking practice sessions at a professional PTE
                        Coaching Centre in {{ $cityName }} help students improve pronunciation, oral fluency, and content
                        structure.
                    </p>
                    ...
                    <p>At the Best PTE Coaching in {{ $cityName }}, trainers teach smart elimination techniques and
                        vocabulary enhancement strategies to improve reading accuracy and speed</p>
                    ...
                    <p>Enrolling in the Best PTE Institute in {{ $cityName }} ensures exposure to real exam-level listening
                        audios and consistent dictation practice, which is crucial for scoring high in this section.</p>

                    <h2>Best PTE Institute in {{ $cityName }} – Expert Trainers & Real Exam Practice</h2>

                    <p>Selecting the Best PTE Institute in {{ $cityName }} is not just about joining classes; it is about
                        choosing a result-oriented training environment. A professional PTE Coaching in {{ $cityName }}
                        provides:</p>

                    <ul>
                        <li>Certified and experienced faculty</li>
                        <li>AI-based mock testing software</li>
                        <li>Individual performance analysis</li>
                        <li>Updated study material</li>
                        <li>Daily practice sessions</li>
                    </ul>

                    <p>At a reputed PTE Coaching Centre in {{ $cityName }}, students are trained with real exam simulations
                        that replicate the actual testing environment. This reduces exam fear and improves time management
                        skills.</p>
                    <p>

                    <p>The Best PTE Classes in {{ $cityName }} also include weekly full-length mock tests. These mocks are
                        analysed in detail to identify scoring gaps and provide corrective feedback.</p>

                    <h2>PTE Online Coaching in {{ $cityName }} – Flexible & Result-Oriented Learning</h2>

                    <p>
                        For working professionals and students who prefer learning from home, PTE Online Coaching in
                        {{ $cityName }} offers a convenient alternative. With advanced digital platforms, live doubt
                        sessions, and interactive speaking practice, online preparation delivers the same quality as
                        classroom training.
                    </p>

                    <p>The advantage of PTE Online Coaching in {{ $cityName }} includes:</p>

                    <ul>
                        <li>Flexible batch timings</li>
                        <li>Access to recorded lectures</li>
                        <li>Online mock test dashboards</li>
                    ...
                    <p>
                        Many students choose PTE Coaching in {{ $cityName }} in hybrid mode, combining classroom and online
                        support for better results.
                    </p>


                    <h2>Best PTE Coaching Centre in {{ $cityName }} – Personalised Score Improvement Strategy</h2>

                    <p>Every student has a different English proficiency level. The Best PTE Coaching Centre in
                        {{ $cityName }} focuses on personalised training plans rather than a one-size-fits-all approach.</p>

                    <p>At a professional PTE Institute in {{ $cityName }}, your preparation journey typically includes:</p>

                    <ul>
                        <li>Initial diagnostic test</li>
                        <li>Skill-wise performance evaluation</li>
                        <li>Customised study plan</li>
                        <li>Daily speaking & writing practice</li>
                        <li>Weekly mock analysis</li>
                    </ul>

                    <p>This structured system ensures continuous improvement. The Best PTE Coaching in {{ $cityName }}
                        emphasises consistency, accuracy, and smart exam strategies to help students reach their target band
                        score.
                    </p>

                    <h2>Facilities Offered by the Best PTE Classes in {{ $cityName }}</h2>

                    <p>
                        A reputed PTE Coaching in {{ $cityName }} provides advanced facilities that enhance the learning
                        experience:
                    </p>

                    <ul>
                        <li>Computer lab for real exam simulation</li>
                        <li>Noise-cancelling microphones for speaking practice</li>
                        <li>Updated Cambridge-level vocabulary support</li>
                        <li>Dedicated doubt-clearing sessions</li>
                        <li>Small batch sizes for personal attention</li>
                    </ul>

                    <p>
                        The Best PTE Institute in {{ $cityName }} ensures that each student receives individual mentoring
                        and performance tracking. Enrolling in a reliable PTE Coaching Centre in {{ $cityName }} means
                        preparing in a professional, focused environment.
                    </p>

                    <h2>Who Should Join PTE Coaching in {{ $cityName }}?</h2>

                    <p>
                        You should consider joining PTE Coaching in {{ $cityName }} if you:
                    </p>

                    <ul>
                        <li>Plan to study abroad</li>
                        <li>Are applying for PR or migration</li>
                        <li>Need a quick English proficiency test result</li>
                        <li>Want AI-based transparent scoring</li>
                        <li>Need structured guidance for preparation</li>
                    </ul>

                    <p>The Best PTE Coaching Centre in {{ $cityName }} is suitable for beginners, intermediate learners, and
                        advanced candidates aiming for 65+, 79+, or higher scores.</p>

                    <p>If you cannot attend offline sessions, PTE Online Coaching in {{ $cityName }} ensures you receive
                        expert training without compromising on quality.</p>

                    <h2>Result-Focused Training at the Best PTE Institute in {{ $cityName }}</h2>

                    <p>
                        A high PTE score requires more than just English knowledge. It demands:
                    </p>

                    <ul>
                        <li>Smart answering techniques</li>
                        <li>Template-based writing strategy</li>
                        <li>Fluency control</li>
                        <li>Listening accuracy</li>
                        <li>Reading speed</li>
                    </ul>

                    <p>The Best PTE Classes in {{ $cityName }} combine these elements into a systematic preparation plan.
                        Through consistent mock practice at a professional PTE Coaching in {{ $cityName }}, students develop
                        exam temperament and confidence.
                    </p>

                    <p>The Best PTE Coaching in {{ $cityName }} ensures measurable progress through weekly assessments and
                        personalised improvement sessions.</p>


                    <h2>Why Students Trust the Best PTE Coaching in {{ $cityName }}</h2>

                    <p>Students prefer a reputed PTE Coaching Centre in {{ $cityName }} because of:</p>

                    <ul>
                        <li>Proven track record</li>
                        <li>Transparent guidance</li>
                        <li>Ethical counselling support</li>
                        <li>Regular progress updates</li>
                        <li>Dedicated mentoring</li>
                    </ul>

                    <p>
                        The Best PTE Institute in {{ $cityName }} focuses not only on exam preparation but also on building
                        long-term communication skills useful for academic and professional environments abroad.
                    </p>

                    <p>With advanced resources, real-time mock platforms, and expert mentorship, PTE Online Coaching in
                        {{ $cityName }} and classroom training both provide equal opportunities for success.</p>

                    <h2>Advanced Practice & Mock Tests at PTE Coaching Centre in {{ $cityName }}</h2>

                    <p>
                        Mock tests are a crucial part of preparation. At a professional PTE Coaching in {{ $cityName }},
                        students attempt multiple full-length tests under exam-like conditions.
                    </p>

                    <p>The Best PTE Classes in {{ $cityName }} provide:</p>

                    <ul>
                        <li>Section-wise practice tests</li>
                        <li>AI-evaluated speaking and writing scores</li>
                        <li>Detailed performance reports</li>
                        <li>Time management training</li>
                        <li>Error analysis sessions</li>
                    </ul>
                    <p>Regular testing at the Best PTE Coaching Centre in {{ $cityName }} ensures you understand scoring
                        patterns and improve strategically.</p>


                    <h2>Comprehensive Support at the Best PTE Institute in {{ $cityName }}</h2>

                    <p>From admission counselling to exam booking guidance, a reputed PTE Institute in {{ $cityName }}
                        offers end-to-end support. The Best PTE Coaching in {{ $cityName }} ensures that students are fully
                        prepared before booking their exam date.</p>

                    <p>Whether you join classroom-based PTE Classes in {{ $cityName }} or opt for PTE Online Coaching in
                        {{ $cityName }}, structured training, expert mentoring, and real exam practice significantly
                        increase your chances of achieving your desired score.</p>

                    <p>Choosing the Best PTE Coaching Centre in {{ $cityName }} is an investment in your academic and
                        professional future. With consistent effort, personalised strategies, and expert guidance, achieving
                        a high PTE score becomes a realistic and achievable goal.</p>
