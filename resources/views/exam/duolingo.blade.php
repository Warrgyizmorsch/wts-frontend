...
@section('content')
            ...
            <style>
                ...
                /* GLOBAL RESPONSIVE FIX FOR Duolingo PAGE */
                ...
                <div class="hero-content-wrapper container">
                    ...
                    <div class="home-hero-content container">
                        ...
                        <h1 class="hero-title" style="color:var(--primary-color)">
                            Best Duolingo Coaching in {{ $cityName }}<br>
                            <span style="color:black">Expert Guidance & Top Scores</span>
                        </h1>

                        <ul style="margin:18px 0;padding-left:0;">
                            <p style="color:black">Looking for reliable Duolingo preparation in {{ $cityName }}? WTS provides result-oriented training through structured Duolingo Classes in {{ $cityName }}, real exam-pattern practice tests, and personalised mentoring support. Enrol in the Best Duolingo Coaching in {{ $cityName }} with flexible classroom and online learning options to achieve your desired score confidently.
                            </p>
                        </ul>
                        ...
                        <div class="ielts-image-wrap">
                            ...
                            <div class="band-box">
                                ...
                                <div id="registrationModals" class="registration-form ">
                                    <h2 style="margin: 0px;">Book Your Free Duolingo Demo Class</h2>
                                    <form id="registrationForm" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" id="visa-country" name="visa_country" required
                                                placeholder="Purpose of Duolingo">
                                        </div>
            ...
            <section class="ielts-overview">
                ...
                <div class="container">
                    ...
                    <h2 class="ielts-overview-title">Duolingo Overview</h2>

                    <p class="ielts-overview-text">
                        The Duolingo English Test (DET) is a globally recognised English proficiency exam accepted by universities worldwide for undergraduate and postgraduate admissions. It evaluates your skills in Literacy, Comprehension, Conversation, and Production, helping institutions assess your overall English communication ability.
                    </p>
                    <p class="ielts-overview-text">At our Duolingo Coaching in {{ $cityName }}, we provide complete preparation covering all question types with expert strategies, concept-based practice, real exam-level mock tests, and continuous performance analysis. Our focused training approach emphasises fluency, vocabulary improvement, grammar accuracy, and score enhancement.</p>

                    <p class="ielts-overview-text">Our Duolingo Classes in {{ $cityName }} are designed for beginners as well as advanced aspirants, offering structured and result-oriented preparation. With personalised mentoring and proven strategies, we are recognised as the Best Duolingo Coaching in {{ $cityName }} to help you achieve your target score with confidence.</p>

                    <!-- <p class="ielts-overview-text">
                                As a leading Duolingo institute in {{ $cityName }}, WTS Study Abroad Consultants prepares students for all four
            ...
            <section class="ielts-metrics">
                ...
                <div class="container">
                    ...
                    <h2>Our Duolingo Success in Numbers</h2>
                    <!-- <p>A track record that highlights our commitment to Duolingo success.</p> -->
            ...
            <!-- New Section Where Duolingo Take -->
            @include('components.where-exam-can-take', ['exam' => 'Duolingo'])
            ...
            <section class="why-choose">
                ...
                <p>Why Students Prefer Our Duolingo Coaching in {{ $cityName }}</p>

                <div class="choose-grid">

                    <div class="choose-item">
                        <i class="fa-solid fa-user-graduate c1"></i>
                        <span>Certified Duolingo Mentors</span>
                    </div>
            ...
            <section class="ielts-course">
                ...
                <div class="container">
                    ...
                    <h2>Duolingo Course Structure</h2>

                    <p class="subtitle">
                        At WTS, our Duolingo coaching program is carefully designed to cover all four core modules of the exam:
                        Listening, Reading, Writing, and Speaking.
                        Our structured approach helps students build confidence, accuracy, and test readiness.
                    </p>

                    <a href="javascript:void(0)" class="course-cta js-open-custom-study-modal">Enroll in our Duolingo Online Coaching Program</a>
            ...
            <section class="ielts-test">
                ...
                <div class="container">
                    ...
                    <h2>Which Duolingo Test Should You Take?</h2>

                    <!-- <p>Choosing the correct Duolingo test is an important step in your study abroad journey. At WTS Study Abroad
                                Consultant, we help you understand which option aligns best with your goals.</p> -->

                    <div class="test-tabs">
                        <div class="test-tab active" data-tab="academic">Duolingo iBT Test</div>
                        <div class="test-tab" data-tab="general">Duolingo Essentials</div>
                    </div>

                    <div class="test-content" id="academic">

                        <p>This is the most widely acceDuolingod Duolingo test by colleges and universities worldwide. It measures your
                            ability to use
                        ...
                        <!-- <ul>
                                    ...
                                    <li>AcceDuolingod by universities in countries like the UK, Australia, Canada, New Zealand, and Europe.</li>
                    ...
                    <div class="test-content" id="general" style="display:none;">
                        ...
                        <p>This is a shorter and more affordable test that evaluates your everyday English skills along with
                            academic English. It
                            is acceDuolingod by selected institutions and is suitable for students looking for flexible and accessible
                            testing options.</p>
                        <!-- <ul>
                                    ...
                                    <li>AcceDuolingod for employment purposes and certain immigration pathways.</li>
            ...
            <section class="ielts-experts">
                ...
                <div class="container">
                    ...
                    <h3>Learn from Certified Duolingo Trainers in {{ $cityName }}</h3>

                    <p class="sub">
                        Our trainers at WTS bring years of experience in delivering high-quality Duolingo coaching in {{ $cityName }}.
                        You
                        receive:
                    </p>
                    ...
                    <div class="experts-wrap">
                        ...
                        <div class="expert-card">
                            ...
                            <div class="expert-role">Duolingo Trainer</div>
                            <p class="expert-desc">Experienced Duolingo Trainer – Certified Instructor with 5+ Years Expertise.</p>
                        ...
                        <div class="expert-card">
                            ...
                            <div class="expert-role">Duolingo Trainer</div>
                            <p class="expert-desc">Experienced British Council Certified <br>Duolingo Trainer – 6+ Years Expertise.</p>
                            <div class="expert-meta">
            ...
            <section class="ielts-plan">
                ...
                <div class="container">
                    ...
                    <h2><span style="color:var(--primary-color)">Choose Your Duolingo </span> Preparation Plan</h2>
                        ...
                        <div class="stack-track" id="track">
                            ...
                            <div class="stack-card">
                                <div class="stack-user">
                                    <div><b>Sakshi Agarwal</b><br><small>Jaipur</small></div>
                                </div>
                                <p>  I joined Duolingo coaching at WTS Study Abroad Consultant after scoring low in my first attempt. The trainers guided me properly on speaking and writing formats. Regular practice tests and personal feedback helped me improve my score from 95 to 120 within a short time.
                                </p>
                            </div>
                            ...
                            <div class="stack-card">
                                <div class="stack-user">
                                    ...
                                    <div><b>Yash Thakur</b><br><small>Delhi</small></div>
                                </div>
                                <p>Choosing WTS for Duolingo preparation was the best decision. The faculty explained every question type clearly and gave useful tips for time management. The mock tests were very close to the actual exam pattern, which boosted my confidence.</p>
                            </div>

                            <div class="stack-card">
                                <div class="stack-user">
                                    <!-- <img src="/images/User.jpg"> -->
                                    <div><b>Tanvi Sharma</b><br><small>Mumbai</small></div>
                                </div>
                                <p> I was searching for a professional Duolingo institute with real exam-level practice, and WTS truly met my expectations. The speaking practice sessions and vocabulary improvement strategies helped me achieve my target score of 115 in my first attempt.</p>
                            </div>

                            <div class="stack-card">
                                <div class="stack-user">
                                    <!-- <img src="/images/Neha.jpg"> -->
                                    <div><b>Harsh Vardhan</b><br><small>Ahemdabad</small></div>
                                </div>
                                <p>Due to my college schedule, I opted for Duolingo online coaching at WTS Study Abroad Consultant. The live sessions, recorded lectures, and individual mentoring were excellent. Even in online mode, I received detailed performance analysis after every mock test.</p>
                            </div>

                            <div class="stack-card">
                                <div class="stack-user">
                                    <!-- <img src="/images/Ayesha.jpg"> -->
                                    <div><b>Nidhi Jain</b><br><small>Ajmer</small></div>
                                </div>
                                <p>What makes WTS different is their small batch size and personalized attention. The trainers helped me improve my fluency and writing structure within a few weeks. I felt fully prepared and confident while taking the Duolingo English Test.</p>
                            </div>
            ...
            <section class="ielts-cta">
                <div class="container">
                    ...
                    <div class="cta-box">
                        ...
                        <div class="cta-image">
                            <img src="/images/DUOLINGO.webp" alt="">
                        </div>

                        <div class="cta-content">
                            <h2>Join the Best Duolingo Coaching in {{ $cityName }} Today</h2>
                            <p>Start your Duolingo preparation with WTS Study Abroad Consultants, a trusted Duolingo coaching centre in
            ...
            <section class="ielts-long">
                <div class="container">
                    ...
                    <div class="long-box">
                        ...
                        <h2>Duolingo Coaching in {{ $cityName }} – Smart Preparation for Fast Results</h2>

                        <p>
                            At WTS Study Abroad Consultants, we provide structured and result-oriented Duolingo Coaching in {{ $cityName }} for students planning to study abroad. The Duolingo English Test is widely accepted by universities across the USA, Canada, UK, Australia, and Europe, and requires focused preparation with the right strategies.
                        </p>

                        <p>
                            Recognized as the Best Duolingo Coaching in {{ $cityName }}, we help students understand the adaptive exam format, improve English proficiency, and build the confidence needed to achieve a competitive score. Our training approach combines concept clarity, real-time practice, and continuous performance monitoring.
                        </p>

                        <p>Whether you are starting from scratch or looking to improve your previous score, our Duolingo Coaching {{ $cityName }} programs are designed to match your individual learning needs.</p>
                        ...
                        <div class="more-content" id="moreContent">
                            ...
                            <h2>Why Choose WTS – Best Duolingo Institute in {{ $cityName }}</h2>

                            <p>
                               Choosing the right Duolingo Institute in {{ $cityName }} plays a key role in achieving your target score. At WTS, we focus on structured learning, exam pattern familiarity, and personalized mentoring.
                            </p>

                            <p>As the Best Duolingo Institute in {{ $cityName }}, we offer:</p>

                            <ul>
                                <li>Experienced English language trainers</li>
                                <li>Adaptive test practice modules</li>
                                <li>Real exam simulation</li>
                                <li>Personalized study plans</li>
                                <li>Speaking and writing evaluation</li>
                                <li>Vocabulary and grammar enhancement</li>
                            </ul>

                            <p>Students enrolled in our Duolingo Coaching Centre in {{ $cityName }} benefit from a focused and supportive learning environment where progress is consistently tracked.</p>

                            <h2>Comprehensive Duolingo Classes in {{ $cityName }}</h2>

                            <p>
                               Our Duolingo Classes in {{ $cityName }} cover all components of the Duolingo English Test, including reading, writing, listening, and speaking tasks. The exam is adaptive, which means the difficulty level changes based on your responses. Our trainers ensure you understand this format thoroughly.
                            </p>

                            <p>As part of the Best Duolingo Classes in {{ $cityName }}, we provide:</p>

                            <ul>
                                <li>Section-wise practice sessions</li>
                                <li>Timed drills for quick responses</li>
                                <li>Speaking fluency exercises</li>
                                <li>Writing structure guidance</li>
                                <li>Grammar correction sessions</li>
                                <li>Daily vocabulary improvement</li>
                            </ul>

                            <p>
                                This structured method makes WTS a trusted choice for Duolingo Coaching in {{ $cityName }}
                            </p>

                            <h2>Structured Duolingo Coaching {{ $cityName }} – Our Approach</h2>

                            <p>Our Duolingo Coaching {{ $cityName }} begins with an assessment test to evaluate your English proficiency. Based on your results, we create a customized learning roadmap focusing on your weak areas.</p>

                            <p>At our Duolingo Coaching Centre in {{ $cityName }}, the preparation includes:</p>

                            <ul>

                                <li>Adaptive practice sets</li>
                                <li>Real-time speaking evaluation</li>
                                <li>Mock tests under exam conditions</li>
                                <li>Performance tracking reports</li>
                                <li>Strategy sessions for high scores</li>

                            </ul>

                           <p>This systematic approach ensures that students at our Duolingo Institute in {{ $cityName }} stay confident and exam-ready.</p>


                            <h2>Duolingo Online Coaching in {{ $cityName }} – Learn from Anywhere</h2>

                            <p>For students who prefer flexibility, we offer Duolingo Online Coaching in {{ $cityName }} through live interactive classes. This program is ideal for working professionals and students with busy schedules.</p>

                            <p>Our Duolingo Online Coaching in {{ $cityName }} includes:</p>
                            ...
                            <p>Even in online mode, we maintain the same quality standards as our classroom-based Duolingo Coaching in {{ $cityName }}.</p>
                            <p>

                            <p>Students enrolled in Duolingo Online Coaching in {{ $cityName }} receive continuous academic support and mentoring throughout their preparation journey.</p>

                            <h2>Real Exam Simulation & Mock Testing</h2>

                            <p>
                              Practice is the key to success in the Duolingo exam. As the Best Duolingo Coaching Centre in {{ $cityName }}, we conduct:
                            </p>

                            <ul>
                                <li>Weekly practice tests</li>
                                <li>Full-length adaptive mock exams</li>
                                <li>Time-based response training</li>
                                <li>Speaking practice evaluations</li>
                                <li>Writing feedback sessions</li>
                                <!-- <li>Doubt-solving support</li> -->
                            </ul>

                            <p>
                               These simulations help students gain familiarity with the exam format. Our consistent testing system is one of the reasons we are known as the Best Duolingo Coaching in {{ $cityName }}.
                            </p>


                            <h2>Flexible Batch Options</h2>

                            <p>Our Duolingo Classes in {{ $cityName }} are available in:</p>

                            <ul>
                                <li>Regular weekday batches</li>
                                <li>Weekend batches</li>
                                <li>Fast-track preparation programs</li>
                                <li>Customized one-on-one sessions</li>
                                <li>Live online training</li>
                            </ul>

                            <p>This flexibility ensures that students can choose the format that suits their schedule while receiving training from the Best Duolingo Institute in {{ $cityName }}.</p>

                            <h2>Updated Study Material & Learning Resources</h2>

                            <p>
                               At WTS, we provide updated resources aligned with the latest Duolingo exam format. Students enrolled in our Duolingo Coaching Centre in {{ $cityName }} receive:
                            </p>

                            <ul>
                                <li>Adaptive practice worksheets</li>
                                <li>Grammar improvement modules </li>
                            ...
                            <p>
                                These resources contribute to our reputation as the Best Duolingo Classes in {{ $cityName }} for serious aspirants.
                            </p>

                            <h2>Who Should Join Our Duolingo Coaching in {{ $cityName }}</h2>
                            ...
                            <ul>
                                ...
                                <li>Applicants requiring quick English proficiency certification</li>
                                <li>Working professionals seeking flexible preparation</li>
                                <li>Individuals aiming for scholarship opportunities</li>
                            </ul>

                            <p>If you are serious about achieving your target score, enrolling in the Best Duolingo Coaching Centre in {{ $cityName }} can significantly improve your performance.</p>

                            <h2>Admission Process at WTS Study Abroad Consultants</h2>

                            <p>
                                Joining our Duolingo Coaching in {{ $cityName }} is simple:
                            </p>

                            <ul>
                                <li>Book a consultation session</li>
                                <li>Take an assessment test</li>
                                <li>Receive a personalized study plan</li>
                                <li>Select your preferred batch (offline or online)</li>
                                <li>Begin structured preparation</li>
                            </ul>

                            <p>As a trusted Duolingo Institute in {{ $cityName }}, we ensure a smooth and student-friendly enrollment process.
                            </p>


                            <h2>Expert Faculty & Continuous Mentoring</h2>

                            <p>
                               Our experienced trainers focus on skill development, exam strategies, and performance tracking. Their guidance and structured teaching methods make WTS the Best Duolingo Institute in {{ $cityName }} for students targeting high scores.
                            </p>

                            <p>Through disciplined preparation, adaptive practice, and regular evaluations, our Duolingo Coaching {{ $cityName }} equips students with the skills required for international academic success.</p>
