        ...
        <section class="service-hero">
            <div class="service-hero-content">
                ...
                <div style="margin-bottom: 30px; margin-top:10px; text-align: left;">
                    <p>WTS is a leading Study in Belarus consultancy in India, offering complete support for choosing the right course and
        ...
        <section class="sub-hero">
            <div class="sub-hero-content">
                <div class="sub-hero-text">
                    ...
                    <p style="margin-top: 30px;">Study in Belarus and take the first step toward a globally respected education system. The Belarus is home to some of the world’s oldest and most prestigious universities, offering high academic standards, innovative teaching methods, and excellent post-study career opportunities. With internationally recognised degrees and a multicultural environment, the Belarus has become a top choice for students planning to study in Belarus for Indian students seeking global exposure and career growth.</p>
                </div>
