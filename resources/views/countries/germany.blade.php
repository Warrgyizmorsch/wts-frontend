...
@section('content')
    ...
    <section class="service-hero">
        <div class="service-hero-content">
            <h1 class="main-heading" style="font-size: 34px;">Study in Germany - Your Pathway to International Education
                Excellence</h1>
        ...
        <div class="sub-hero-content">
            <div class="sub-hero-text">
                ...
                <p style="margin-top: 30px;">Study in Germany and take the first step toward a globally recognized
                    education. Germany is known for its world-class universities, cutting-edge research, and strong industry
                    connections. We guide students through university selection, visa processing, scholarships, and test
                    preparation. With high-quality education, innovation, and excellent post-study career opportunities,
                    Germany has become a preferred destination for students planning to study abroad in Germany.
                    International students can focus on building a successful academic and professional future in one of
                    Europe’s most dynamic educational hubs.</p>
            </div>
