    ...
    <section class="service-hero">
        <div class="service-hero-content">
            ...
            <div style="margin-bottom: 30px; margin-top:10px; text-align: left;">
                <p>WTS is a leading Study in Vatican City consultancy in India, offering complete support for choosing the
                    right course and
    ...
    <section class="sub-hero">
        <div class="sub-hero-content">
            <div class="sub-hero-text">
                ...
                <p style="margin-top: 30px;">Study in Vatican City and take the first step toward a globally respected
                    education system. The Vatican City is home to some of the world’s oldest and most prestigious
                    ...
                    Vatican City has become a top choice for students planning to study in Vatican City for Indian students
