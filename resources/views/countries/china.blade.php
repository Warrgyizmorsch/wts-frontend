...
@section('content')
    ...
    <section class="service-hero">
        <div class="service-hero-content">
            <h1 class="main-heading" style="font-size: 34px;">Study in China – World-Class Education with Global Career
                Opportunities</h1>
            <div style="margin-bottom: 30px; margin-top:10px; text-align: left;">
                <p>WTS is a leading Study in China consultancy in India, offering complete support for choosing the right
                    course and
    ...
    <section class="sub-hero">
        <div class="sub-hero-content">
            <div class="sub-hero-text">
                ...
                <p style="margin-top:30px;">Study in China and take a step toward high-quality, globally recognised
                    education at an affordable cost. China has rapidly become one of the most popular destinations for
                    international students due to its advanced universities, strong research output, and generous China
                    scholarship opportunities. With a wide range of English-taught programs and world-class infrastructure,
                    China offers an ideal environment for students aiming for academic excellence and global career growth.
                </p>
            </div>
